 ...
 */
public class OldHurlStack implements HttpStack {
     ...
     */
    public OldHurlStack(UrlRewriter urlRewriter) {
     ...
     */
    public OldHurlStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) {
