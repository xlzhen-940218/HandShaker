...
/* renamed from: org.a.a.bf */
/* loaded from: classes.dex */
public final class C0873bf extends AbstractC0883f {

    /* renamed from: a */
    String f4027a;

    public C0873bf(byte[] bArr) {
        char[] cArr = new char[bArr.length];
        for (int i = 0; i != cArr.length; i++) {
            cArr[i] = (char) (bArr[i] & 255);
        }
        this.f4027a = new String(cArr);
    }
    ...
    public final void mo143a(C0860at c0860at) {
        char[] charArray = this.f4027a.toCharArray();
        byte[] bArr = new byte[charArray.length];
        for (int i = 0; i != charArray.length; i++) {
            bArr[i] = (byte) charArray[i];
        }
        try {
            c0860at.m172a(26, bArr);
        } catch (IOException e) {
    ...
    final boolean mo150a(AbstractC0856ap abstractC0856ap) {
        if (abstractC0856ap instanceof C0873bf) {
            return this.f4027a.equals(((C0873bf) abstractC0856ap).f4027a);
        }
        return false;
    }
