...
/* renamed from: org.a.a.aj */
/* loaded from: classes.dex */
public final class C0850aj extends AbstractC0883f {

    /* renamed from: a */
    private String f4006a;

    public C0850aj(byte[] bArr) {
        char[] cArr = new char[bArr.length];
        for (int i = 0; i != cArr.length; i++) {
            cArr[i] = (char) (bArr[i] & 255);
        }
        this.f4006a = new String(cArr);
    }
    ...
    public final void mo143a(C0860at c0860at) {
        char[] charArray = this.f4006a.toCharArray();
        byte[] bArr = new byte[charArray.length];
        for (int i = 0; i != charArray.length; i++) {
            bArr[i] = (byte) charArray[i];
        }
        try {
            c0860at.m172a(27, bArr);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    final boolean mo150a(AbstractC0856ap abstractC0856ap) {
        if (abstractC0856ap instanceof C0850aj) {
            return this.f4006a.equals(((C0850aj) abstractC0856ap).f4006a);
        }
        return false;
    }
}
